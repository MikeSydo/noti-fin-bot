...
### Added
- **⏱️ Receipt Parsing Timeouts**: Added a 60-second timeout for Gemini AI requests to ensure bot stability and prevent hanging during heavy processing periods.
